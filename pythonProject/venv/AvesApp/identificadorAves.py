...
with st.sidebar:
    ...
    st.write("**_1. Para iniciar la identificación elige algún filtro, pincha en el "
        "cuadro de selección y busca una opción._**")
    ...
    if st.checkbox("Ave"):
        nombreAve = st.selectbox('Elige un ave', ['',
                                                  ...
                                                  'Herrerillo Común',
                                                  'Jilguero',
                                                  'Jilguero Lúgano Hembra',
                                                  'Jilguero Lúgano Macho',
